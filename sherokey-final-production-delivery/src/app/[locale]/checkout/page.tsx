      ...
      <div className="grid gap-8 lg:grid-cols-3">
        <div className="rounded-2xl border border-[--color-border] bg-[--color-card] p-6 lg:col-span-2">
          ...
          <CheckoutForm
            ...
            showPaypal={settings.paymentProviders.paypal}
            testMode={settings.paymentProviders.sandbox}
            labels={{
              ...
              testModeNotice: "Test mode: no live payment gateway is configured, so this order will be confirmed instantly for demo purposes.",
            }}
          />
        </div>
